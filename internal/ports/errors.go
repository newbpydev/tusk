...
// a sanitized domain/context category; no driver error is exposed by Unwrap.
...
func (e TransactionError) Error() string {
	return "storage: " + e.operation + " outcome unknown (" + e.cause.Error() + ")"
}
func (e TransactionError) Is(target error) bool { return errors.Is(e.cause, target) }
